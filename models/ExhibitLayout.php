...
class ExhibitLayout
{
    ...
    public static function getLayoutArray()
    {
        ...
        $defaultLayouts = array(
            ...
            'text' => array(
                'name' => __('Text'),
                'description' => __('Layout featuring a block of text without files (accepts shortcodes)')
            ),
            'lightbox-gallery' => array(
                'name' => __('Lightbox Gallery'),
                'description' => __('A gallery layout using Lightbox to display all files associated with an item')
            )
        );
